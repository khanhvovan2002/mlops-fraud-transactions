...
# Read dataset
transactions_data = pd.read_csv(raw_transaction_data_path,  parse_dates=['timestamp'])
user_events_data = pd.read_csv(raw_client_data_path,index_col=0, quotechar="\'", parse_dates=['timestamp'])
#preproccessing
...
train, test = train_test_split(data, test_size=0.3, stratify=X['fraud'])
